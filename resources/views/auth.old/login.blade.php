        ...
        <div class="container">
            <div class="card login-card">
                <div class="row no-gutters">
                    <div class="col-md-5">
                        <img src="logo-sekolah.jpg" alt="login" class="login-card-img ml-3">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ url('/login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Alamat Email">
                                    @error('password')

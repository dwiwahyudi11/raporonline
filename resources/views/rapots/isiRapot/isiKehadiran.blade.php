...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            <form action="/rapots/simpanKehadiran" method="POST">
                @csrf
                <div class="card-body">
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="form-group col-sm-3">
                                                ...
                                                <label>Sakit</label>
                                                <input class="form-control" type="number" name="sakit[]" id="sakit" required>
                                            </div>
                                            <div class="form-group col-sm-3">
                                                <label>Izin</label>
                                                <input class="form-control" type="number" name="izin[]" id="izin" required>
                                            </div>
                                            <div class="form-group col-sm-3">
                                                <label style="font-size: 15px">Tanpa Keterangan</label>
                                                <input class="form-control" type="number" name="tanpa_keterangan[]" id="tanpa_keterangan" required>
                                            </div>
                                            <div class="form-group col-sm-3">
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <textarea class="form-control" name="catatan_wali_kelas[]" id="catatan_wali_kelas"></textarea>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
